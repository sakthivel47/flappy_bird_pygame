...
# pygame.mixer.pre_init(frequency=44100, size=16, channels=1, buffer=10)
...
while True:
    for event in pygame.event.get():  # pygame looks for events (inputs from user)
        if event.type == pygame.QUIT: 
            pygame.quit()  # uninitializing the game
            sys.exit()  # to end the program correctly
